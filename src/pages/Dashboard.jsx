                      ...
                      <div className="flex-1">
                        {edificioInModifica === edificio.id ? (
                            <form onSubmit={(e) => salvaModificaEdificio(e, edificio.id)} className="flex gap-2 w-full">
                              ...
                              />
                              <button type="submit" className="bg-green-500 text-black px-4 font-bold text-xs uppercase">Salva</button>
                              <button type="button" onClick={() => setEdificioInModifica(null)} className="border-2 border-white px-4 font-bold text-xs uppercase">Annulla</button>
                            </form>
                        ) : (
